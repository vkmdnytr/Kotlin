...
class UpComingAdapter(private var mDataSource: List<MovieResultsItem>?, private val onListener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
